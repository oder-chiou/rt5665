...
static const struct snd_soc_dapm_widget rt5665_dapm_widgets[] = {
	...
	/* Boost */
	SND_SOC_DAPM_PGA("BST1", RT5665_PWR_ANLG_2,
		RT5665_PWR_BST1_P_BIT, 0, NULL, 0),
	SND_SOC_DAPM_PGA("BST2", RT5665_PWR_ANLG_2,
		RT5665_PWR_BST2_P_BIT, 0, NULL, 0),
	SND_SOC_DAPM_PGA("BST3", RT5665_PWR_ANLG_2,
		RT5665_PWR_BST3_P_BIT, 0, NULL, 0),
	SND_SOC_DAPM_PGA("BST4", RT5665_PWR_ANLG_2,
	...
	/* REC Mixer */
	SND_SOC_DAPM_MIXER("RECMIX1L", RT5665_PWR_MIXER, RT5665_PWR_RM1_L_BIT,
		0, rt5665_rec1_l_mix, ARRAY_SIZE(rt5665_rec1_l_mix)),
	SND_SOC_DAPM_MIXER("RECMIX1R", RT5665_PWR_MIXER, RT5665_PWR_RM1_R_BIT,
		0, rt5665_rec1_r_mix, ARRAY_SIZE(rt5665_rec1_r_mix)),
	SND_SOC_DAPM_MIXER("RECMIX2L", RT5665_PWR_MIXER, RT5665_PWR_RM2_L_BIT,
		0, rt5665_rec2_l_mix, ARRAY_SIZE(rt5665_rec2_l_mix)),
	SND_SOC_DAPM_MIXER("RECMIX2R", RT5665_PWR_MIXER, RT5665_PWR_RM2_R_BIT,
		0, rt5665_rec2_r_mix, ARRAY_SIZE(rt5665_rec2_r_mix)),
	...
	SND_SOC_DAPM_SUPPLY("ADC2 L Power", RT5665_PWR_DIG_2,
		RT5665_PWR_ADC_L2_BIT, 0, NULL, 0),
	SND_SOC_DAPM_SUPPLY("ADC2 R Power", RT5665_PWR_DIG_2,
	...
	SND_SOC_DAPM_MIXER("Stereo2 ADC MIXL", SND_SOC_NOPM,
		0, 0, rt5665_sto2_adc_l_mix,
		ARRAY_SIZE(rt5665_sto2_adc_l_mix)),
	SND_SOC_DAPM_MIXER("Stereo2 ADC MIXR", SND_SOC_NOPM,
		0, 0, rt5665_sto2_adc_r_mix,
